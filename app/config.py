...
RETRIEVER_SELF_QUERY_EXAMPLES = (
    json.loads(os.getenv("RETRIEVER_SELF_QUERY_EXAMPLES"))
    if os.getenv("RETRIEVER_SELF_QUERY_EXAMPLES")
    else [
        (
...
VECTORSTORE_RETRIEVER_SELF_QUERY = (
    os.getenv("VECTORSTORE_RETRIEVER_SELF_QUERY", "1") == "1"
)
